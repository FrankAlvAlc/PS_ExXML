				...
				<header class="navbar navbar-default navbar-static-top">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-left hidden-sm hidden-xs">
							...
							<li>
								<form role="search" class="navbar-form main-search" method="post" action="/Rastrear/Resultado">
									<div class="form-group">
                    {{csrf_field()}}
										<input type="text" placeholder="Rastrear paquete..." name="txtGuiaRastreo" id="txtGuiaRastreo" class="form-control">
										<button class="btn search-button" type="submit">
