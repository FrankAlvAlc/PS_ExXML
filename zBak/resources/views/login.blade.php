...
<html lang="es-MX">
	...
	<head>
		...
		<link rel="stylesheet" href="assets/css/themes/lyt1-theme-1.css" >
	...
	<body class="login">
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4 col-lg-2 col-lg-offset-5">
				...
				@endif
				<p class="text-center">
					Por favor, introduzca su nombre de usuario y password para iniciar sesión.
				</p>
        {{csrf_field()}}
				<div class="box-login">
					<?php
					...
					<form class="form-login"  method="post" name="formLogin" id="formLogin" action="/Login">
						...
						<div class="form-group form-actions">
							...
							<input type="password" class="form-control password" name="txtPwd" id="txtPwd" placeholder="Password">
