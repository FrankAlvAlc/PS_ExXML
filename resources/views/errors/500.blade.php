...
<html lang="en">
	...
	<!-- start: HEAD -->
	<head>
		<title>Grupo Sánchez - Error</title>
		<!-- start: META -->
		...
		<link rel="stylesheet" href="{{asset('assets/css/themes/lyt1-theme-5.css')}}" >
		<!-- end: Packet CSS -->
		<!-- Favicon -->
				...
				<div class="row">
					<div class="col-sm-12 page-error">
						...
						<div class="error-details col-sm-6 col-sm-offset-3">
							<h3>Oops! XML Mal Formado o Invalido</h3>
							<p>
								El XML <b style="color:#000000;">{{$exception->getMessage() }}</b> es invalido o contiene errores
								<br>
								La aplicación ha cancelado el proceso.
								<br>
								Verifique sus archivos digitales e intetelo nuevamente
								<br>
								<a href="/Menu" class="btn btn-red btn-return">
									Regresar al sistema
								</a>
